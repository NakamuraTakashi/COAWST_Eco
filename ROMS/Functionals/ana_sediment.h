...
!
          DO k=1,Nbed !
             bed(i,j,k,iaged)=time(ng)
             bed(i,j,k,ithck)=2.0_r8   !10.0_r8
             bed(i,j,k,iporo)=0.7048_r8  !porosity
             DO ised=1,NST
               bed_frac(i,j,k,ised)=1.0_r8/REAL(NST,r8)
             ENDDO
          END DO
...
!--- Uniform sediment case ----------------------------------------
# elif defined ANA_SED_UNIFORM
      DO j=JstrT,JendT
        DO i=IstrT,IendT
!
!  Set bed layer properties.
!
          DO k=1,Nbed !
             bed(i,j,k,iaged)=time(ng)
             bed(i,j,k,ithck)=0.0_r8  !2.0_r8   !10.0_r8 
             bed(i,j,k,iporo)=0.7048_r8  !porosity
             DO ised=1,NST
               bed_frac(i,j,k,ised)=1.0_r8/REAL(NST,r8)
             ENDDO
