...
! ==== Seagrass parameters ===============================================
   ...
   &                    TRIM(ADJUSTL(Vinfo(5)))
                END DO
                varid=varid+1
              CASE ('iHbio2(iSgTotSgCBmS(i))')
                load=.FALSE.
                varid=varid-1
                DO i=1,Nsg
                  varid=varid+1
                  iHbio2(iSgTotSgCBmS(i))=varid
                  DO ng=1,Ngrids
                    Fscale(varid,ng)=scale
                    Iinfo(1,varid,ng)=gtype
                  END DO
   ...
   &                    TRIM(ADJUSTL(Vinfo(5)))
                END DO
                varid=varid+1
              CASE ('iHbio2(iSgLAI(i))')
                load=.FALSE.
                varid=varid-1
                DO i=1,Nsg
                  varid=varid+1
                  iHbio2(iSgLAI(i))=varid
                  DO ng=1,Ngrids
                    Fscale(varid,ng)=scale
                    Iinfo(1,varid,ng)=gtype
                  END DO
...
*/
   ...
   &                    TRIM(ADJUSTL(Vinfo(5)))
              ...
              CASE ('idTbry(iwest,iPIC(i))')
                load=.FALSE.
                varid=varid-1
                DO i=1,Npim
                  varid=varid+1
                  idTbry(iwest,iPIC(i))=varid
                  DO ng=1,Ngrids
                    Fscale(varid,ng)=scale
                    Iinfo(1,varid,ng)=gtype
                  END DO
   ...
   &                    TRIM(ADJUSTL(Vinfo(5)))
                END DO             
                varid=varid+1
              CASE ('idTbry(ieast,iPIC(i))')
                load=.FALSE.
                varid=varid-1
                DO i=1,Npim
                  varid=varid+1
                  idTbry(ieast,iPIC(i))=varid
                  DO ng=1,Ngrids
                    Fscale(varid,ng)=scale
                    Iinfo(1,varid,ng)=gtype
                  END DO
   ...
   &                    TRIM(ADJUSTL(Vinfo(5)))
                END DO             
                varid=varid+1
              CASE ('idTbry(isouth,iPIC(i))')
                load=.FALSE.
                varid=varid-1
                DO i=1,Npim
                  varid=varid+1
                  idTbry(isouth,iPIC(i))=varid
                  DO ng=1,Ngrids
                    Fscale(varid,ng)=scale
                    Iinfo(1,varid,ng)=gtype
                  END DO
   ...
   &                    TRIM(ADJUSTL(Vinfo(5)))
                END DO             
                varid=varid+1
              CASE ('idTbry(inorth,iPIC(i))')
                load=.FALSE.
                varid=varid-1
                DO i=1,Npim
                  varid=varid+1
                  idTbry(inorth,iPIC(i))=varid
                  DO ng=1,Ngrids
                    Fscale(varid,ng)=scale
                    Iinfo(1,varid,ng)=gtype
                  END DO
...
# if defined ORGANIC_MATTER
   ...
   &                    TRIM(ADJUSTL(Vinfo(5)))
              ...
              CASE ('idTbry(iwest,iPI13C(i))')
                load=.FALSE.
                varid=varid-1
                DO i=1,Npim
                  varid=varid+1
                  idTbry(iwest,iPI13C(i))=varid
                  DO ng=1,Ngrids
                    Fscale(varid,ng)=scale
                    Iinfo(1,varid,ng)=gtype
                  END DO
   ...
   &                    TRIM(ADJUSTL(Vinfo(5)))
                END DO             
                varid=varid+1
              CASE ('idTbry(ieast,iPI13C(i))')
                load=.FALSE.
                varid=varid-1
                DO i=1,Npim
                  varid=varid+1
                  idTbry(ieast,iPI13C(i))=varid
                  DO ng=1,Ngrids
                    Fscale(varid,ng)=scale
                    Iinfo(1,varid,ng)=gtype
                  END DO
   ...
   &                    TRIM(ADJUSTL(Vinfo(5)))
                END DO             
                varid=varid+1
              CASE ('idTbry(isouth,iPI13C(i))')
                load=.FALSE.
                varid=varid-1
                DO i=1,Npim
                  varid=varid+1
                  idTbry(isouth,iPI13C(i))=varid
                  DO ng=1,Ngrids
                    Fscale(varid,ng)=scale
                    Iinfo(1,varid,ng)=gtype
                  END DO
   ...
   &                    TRIM(ADJUSTL(Vinfo(5)))
                END DO             
                varid=varid+1
              CASE ('idTbry(inorth,iPI13C(i))')
                load=.FALSE.
                varid=varid-1
                DO i=1,Npim
                  varid=varid+1
                  idTbry(inorth,iPI13C(i))=varid
                  DO ng=1,Ngrids
                    Fscale(varid,ng)=scale
                    Iinfo(1,varid,ng)=gtype
                  END DO
